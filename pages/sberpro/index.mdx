...
![new-app-title.png](./img/new-app-title.webp)
...
![Typical SberPro user’s environment](./img/user-typical.webp)
...
![old-modals.png](./img/old-modals.webp)
...
![old-notif.png](./img/old-notif.webp)
...
![user-flow.png](./img/user-flow.webp)
...
![new-app-widget.png](./img/new-app-widget.webp)
...
![new-app-tabs.png](./img/new-app-tabs.webp)
...
![user-results.png](./img/user-results.webp)
...
- SberPro took part in the Markswebb Digital Corporate Banking Rank in 2020 and directly helped Sberbank take  [1st place](https://markswebb.ru/report/digital-corporate-banking-rank-2020/).
